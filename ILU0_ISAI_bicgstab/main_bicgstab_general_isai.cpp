...
{	
	...
	std::cout << "***************************************************************************************************************************" << std::endl;
	std::cout << "***************************************************************************************************************************" << std::endl;
	std::cout << std::endl << "Welcome to general isai preconditioned BiCGSTAB \n";
	//Copy stuff to gpu
	...
	{
		Batched_General_ISAI_Preconditioned_BiCGSTAB_Gpu(subdir, A_pages, b_pages, x_pages, is_scaled,  solver_results, PST, IST, OET);  
	...
	PrintSolverResults(subdir,solver_results, std::string("Results_general_isai_bicgstab_")  + category + std::string(".txt"));
